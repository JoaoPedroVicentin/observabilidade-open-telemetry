...
import (
	...
	"github.com/JoaoPedroVicentin/observabilidade-open-telemetry/cep-api/internal/entity"
	"github.com/JoaoPedroVicentin/observabilidade-open-telemetry/cep-api/internal/infra/repo"
	"github.com/JoaoPedroVicentin/observabilidade-open-telemetry/cep-api/internal/usecase"
...
func NewWebCEPHandler(conf *configs.Conf, tracer trace.Tracer) *WebCEPHandler {
	return &WebCEPHandler{
		CEPRepository: repo.NewCEPRepository(conf.weatherApiHost, conf.weatherApiPort),
		Configs:       conf,
		Tracer:        tracer,
	}
}
